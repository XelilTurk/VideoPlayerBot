...
async def not_chat(_, m: Message):
    buttons = [
            [
                InlineKeyboardButton("CHANNEL", url="https://t.me/Azerbajan_Film"),
                InlineKeyboardButton("SUPPORT", url="https://t.me/Azerbaijan_Film"),
            ],
            [
                InlineKeyboardButton("🤖 🤖", url="https://t.me/TuranMovies"),
            ]
         ]
    await m.reply_text(text="**Kanalımıza Qatıl  [Film](https://t.me/Azerbaijan_Film) Below 😉!**", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
